...
export const HeroBanner = () =>{
    return(
        <div className="bg-[#C8E870] mt-5 text-black mx-[20px] md:mx-[60px]  flex flex-col sm:flex-row justify-between mt-[40px] pb-[0] pt-[20px] sm:py-[40px] rounded space-y-5 sm:space-y-0 shadow-lg ">
            ...
            <article className="w-full sm:w-1/3 flex flex-col items-center space-y-3 border-b sm:border-0 pb-5 sm:pb-0">
                ...
                <p className="text-[#667085] w-[90%] mx-auto text-center">Commercial Properties in Pipeline</p>
            </article>
        </div>
    )
}