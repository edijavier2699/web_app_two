...
export const HeroBanner = () =>{
    return(
        <div className="bg-[#C8E870] mt-5 text-black mx-[20px] sm:mx-[60px]  flex flex-col sm:flex-row justify-between mb-[25px] pb-[0] pt-[20px] sm:py-[40px] rounded space-y-5 sm:space-y-0 shadow-lg ">
