...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row w-full bg-[#C8E870] overflow-hidden px-[20px] sm:px-[60px]" style={{ minHeight: '92vh' }}>
      <article className="flex flex-col items-center justify-center w-full md:w-2/3 ">
        <div className='space-y-4 w-full '>
          <h1 className="text-4xl mt-[35px] sm:text-4xl md:text-4xl lg:text-7xl font-bold">
