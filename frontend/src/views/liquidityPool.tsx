...
const LiquidityPoolBlock: React.FC<{ title: string; description: string; icon: React.ReactElement; index: number }> = ({ title, description, icon, index }) => {
    return (
        <div key={index} className="rounded-lg flex flex-col items-center border border-gray-500 shadow-lg hover:shadow-xl transition-all duration-500 ease-in-out transform hover:-translate-y-2 bg-black p-6 text-center">
...
export const LiquidityPool = () => {
    ...
    return (
        <section className=" md:px-[60px] py-10 bg-black text-white">
           <header className="mx-[-20px] md:mx-[-60px]  flex flex-col items-center justify-start h-[87vh] bg-cover bg-center text-center mb-10">
                ...
                <p className=" mb-6 max-w-[90%] text-md sm:text-normal mt-3 sm:max-w-[80%] lg:max-w-[50%] mx-auto">
            ...
            <div className="min-h-[67vh] flex flex-col items-center justify-center">
                <h4 className="text-3xl text-center md:text-5xl font-semibold  mb-6">Reimagining Real Estate Investing</h4>
             ...
             <div className="mt-16 flex space-x-6  flex-col md:flex-row h-[500px] items-center text-center md:text-left">
                <div className="md:w-1/2 rounded-lg  h-full items-center flex flex-col justify-center md:px-8 border  border-gray-500 ">
                ...
                <div className="md:w-1/2 h-full flex items-center rounded-lg p-7 bg-black border border-gray-500">
            ...
            <div className="flex flex-col my-12 md:flex-row items-center text-center md:text-left"> 
                ...
                <div className="md:w-1/2 md:pl-8">
                    ...
                    <p className=" font-bold mb-6 max-w-3xl mx-auto">
                        Grow your wealth with fractional real estate and effortless trading.
                    </p>
                </div>
                
            </div>
            <div className="flex border-t border-b border-gray-500  flex-col items-center text-center py-10 mb-12 text-white ">
        ...
        <footer className="flex flex-col lg:flex-row ">
            <div className="sticky top-0  h-[fit-content] z-10 text-white p-4 order-2 lg:order-1"> 
            ...
            <AccordionItem
                    colorClassDescription=" ext-[#667085]"
                    colorClassTitle="text-gray-300"
